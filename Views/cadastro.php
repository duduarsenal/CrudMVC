...
<section class="section-cadastro min-w-[320px] p-2 sm:p-0 sm:w-auto py-8 flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">

    <article class="max-w-[20rem] py-[1rem] px-[.75rem] sm:px-[2rem] text-[1rem] sm:text-[1.15rem] text-center bg-[#5f5f5f40] rounded-[.5rem] text-[#fff0f0]">
        <span class="text-[1.75rem] sm:text-[2.25rem] font-[600] text-[#fa2323]">ATENÇÃO</span>
        <p>Esse projeto foi feito somente com intuito em estudar as tecnologias para Desenvolvimento Web</p>
        <span class="text-[1.25rem] sm:text-[1.5rem] font-[600] text-[#fa2323]">NUNCA</span>
        <p>coloque dados sensiveis como usuarios, emails ou senhas verdadeiras!</p>
    </article>

    <form class="flex flex-col justify-between bg-[white] w-full sm:min-h-[20rem] sm:min-w-[20rem] p-2 sm:p-4 p-4 border-2 border-[#ff000080] drop-shadow-[0_0_20px_rgba(255,0,0,0.7)] outline outline-[3px] outline-[#ff00004d] outline-offset-[.4rem] rounded-[.5rem]" method="POST">
        ...
        <div class="mb-[2.25rem]">
            <div class="relative flex flex-col justify-between sm:min-w-[450px] pt-[1rem] my-[1rem] mx-auto">
